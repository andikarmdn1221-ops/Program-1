...
const DEFAULT_STOCK = [
  ["Kardus Packing Besar", 48, "Aktif", 10],
  ["Kardus Packing Sedang", 65, "Aktif", 15],
  ["Lakban Cokelat", 36, "Aktif", 10],
  ["Bubble Wrap", 18, "Aktif", 6],
  ["Plastik Stretch Film", 4, "Aktif", 5],
  ["Label Pengiriman", 120, "Aktif", 30],
  ["Pallet Kayu", 3, "Aktif", 4],
  ["Tali Strapping", 24, "Aktif", 8],
  ["Plastik Packing", 75, "Aktif", 20],
  ["Sarung Tangan Kerja", 40, "Aktif", 10],
  ["Masker Debu", 55, "Aktif", 15],
  ["Cutter Gudang", 9, "Aktif", 3],
  ["Spidol Permanen", 20, "Aktif", 5],
  ["Kertas A4", 25, "Aktif", 8],
  ["Tinta Printer", 2, "Aktif", 3],
  ["Rompi Keselamatan", 10, "Aktif", 4],
  ["Sepatu Keselamatan", 8, "Aktif", 4],
];
