...
# =============================================================================
# 🎨 INJEKSI CSS KUSTOM: TEMA SAAS MODERN & MENU NAVIGASI KEREN
# =============================================================================
st.markdown("""
<style>
    /* --- 1. LATAR BELAKANG & FONT UTAMA --- */
    .stApp {
    ...
    /* --- 2. RESTYLING SIDEBAR & MENU NAVIGASI --- */
    [data-testid="stSidebar"] {
        background-color: #FFFFFF !important;
        border-right: 1px solid #E2E8F0 !important;
    }
    
    /* Sembunyikan lingkaran titik pada radio button */
    [data-testid="stSidebar"] div[role="radiogroup"] label div:first-child {
        display: none !important;
    }
    
    /* Bentuk ulang label radio menjadi tombol navigasi modern */
    ...
    /* Efek saat kursor diarahkan ke menu (Hover) */
    ...
    /* Efek MENU AKTIF (Terpilih) menggunakan CSS :has() */
    [data-testid="stSidebar"] div[role="radiogroup"] label:has(input[aria-checked="true"]) {
        background-color: #1A202C !important;
        box-shadow: 0 6px 14px rgba(26, 32, 44, 0.2);
        transform: translateX(6px);
    }
    
    /* Warna teks menu bawaan */
    ...
    [data-testid="stMetric"]:hover { transform: translateY(-4px); box-shadow: 0 10px 20px rgba(0, 0, 0, 0.06) !important; }
    [data-testid="stMetricLabel"] p { color: #718096 !important; font-size: 13px !important; font-weight: 700 !important; text-transform: uppercase; letter-spacing: 0.5px; }
    [data-testid="stMetricValue"] div { color: #1A202C !important; font-size: 34px !important; font-weight: 800 !important; }
    ...
    .stButton button:hover, .stDownloadButton button:hover {
        ...
        box-shadow: 0 6px 15px rgba(26, 32, 44, 0.25) !important;
...
# =============================================================================
# KONFIGURASI SECRETS & FUNGSI BANTUAN (TIDAK ADA YANG DIPOTONG)
# =============================================================================
...
with st.sidebar:
    ...
    # 🌟 Menu Terpadu dengan 1 Radio Button (Anti Bug / Bentrok)
    menu_pilihan = st.radio(
        ...
        label_visibility="collapsed" # Label disembunyikan agar terlihat seperti menu murni
    )
    
    # Mengambil teks nama menu (membuang icon emoji di depannya untuk logika routing)
...
if active_menu == "Dashboard Utama":
    ...
    if st.button("📤 Eksekusi Backup ke Telegram", use_container_width=True):
        with st.spinner("Menyiapkan dokumen dan membangun koneksi ke Telegram..."):
            ...
            pesan_backup = f"💾 **BACKUP SYSTEM INITIATED**\n📅 {dapatkan_waktu_wib()}"
